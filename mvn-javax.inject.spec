...
License  : Apache-2.0
Requires: mvn-javax.inject-data = %{version}-%{release}

%description
No detailed description available

%package data
Summary: data components for the mvn-javax.inject package.
Group: Data

%description data
data components for the mvn-javax.inject package.
...
%files data
%defattr(-,root,root,-)
/usr/share/java/.m2/repository/javax/inject/javax.inject/1/javax.inject-1.jar
/usr/share/java/.m2/repository/javax/inject/javax.inject/1/javax.inject-1.pom
